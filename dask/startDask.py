...
if __name__ == '__main__':
    ...
    if rank == 0:
        ...
        Run.get_context().log("cluster", "scheduler: {scheduler}, dashboard: {dashboard}".format(scheduler=scheduler, dashboard=dashboard))
...
#
#        Run.get_context().log("jupyter","ip: {ip_addr}, port: {port}".format(ip_addr=ip, port=jupyter_servers[0]["port"]))
